...
const stylePresets = [
  { name: "Classic", backgroundColor: "#ffffff", backgroundImage: null, backgroundOpacity: 100 },
  { name: "Soft Slate", backgroundColor: "#f8fafc", backgroundImage: null, backgroundOpacity: 100 },
  { name: "Warm Paper", backgroundColor: "#fffbf5", backgroundImage: "/paper-texture-subtle.jpg", backgroundOpacity: 85 },
  { name: "Clean Grid", backgroundColor: "#f8fafc", backgroundImage: "/geometric-pattern-minimal.jpg", backgroundOpacity: 80 },
]
    ...
    <aside className="w-80 h-full bg-white/90 backdrop-blur-xl border-l border-slate-200/60 flex flex-col flex-shrink-0 overflow-hidden">
      ...
      <div className="p-4 border-b border-slate-200/60 flex items-center justify-between flex-shrink-0">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-semibold text-slate-800 text-sm">Design Studio</h2>
        </div>
      ...
      <div className="flex-1 min-h-0 overflow-y-auto p-4 custom-scrollbar space-y-6">
        <div>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-xs font-medium text-slate-500 uppercase tracking-wide">Page Appearance</h3>
            </div>
            <ChevronDown
            ...
            {pageSettingsExpanded && (
              ...
              >
                ...
                <div className="space-y-2">
                  <p className="text-xs font-medium text-slate-500 uppercase tracking-wide">Style presets</p>
                  <div className="grid grid-cols-2 gap-2">
                    {stylePresets.map((preset) => (
                      <button
                        ...
                        className="flex items-center justify-between rounded-lg border border-slate-200 bg-white px-3 py-2 text-xs font-medium text-slate-700 shadow-sm transition-all hover:border-slate-300 hover:bg-slate-50"
                      >
                        <span>{preset.name}</span>
                        <span className="h-3 w-3 rounded-full border border-slate-200" style={{ background: preset.backgroundColor }} />
                      </button>
                    ))}
                  </div>
                </div>
        ...
        <div>
          ...
          <p className="mt-2 text-xs text-slate-500">
            Customizable sections support dynamic placeholders and reusable content blocks.
          </p>
        </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-xs font-medium text-slate-500 uppercase tracking-wide">Content Guidance</h3>
          </div>
          <Textarea
        ...
        <div>
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-xs font-medium text-slate-500 uppercase tracking-wide">Writing Suggestions</h3>
            </div>
            <ChevronDown
