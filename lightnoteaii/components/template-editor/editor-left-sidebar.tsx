    ...
    try {
      ...
      if (data.success && data.block) {
        const newBlock: BlockTemplate = {
          ...
          description: `Generated: ${prompt.slice(0, 50)}...`,
    ...
    <div className="space-y-3">
      <div className="relative">
        <Textarea
          ...
          className="min-h-[80px] pr-12 text-sm bg-slate-50 border-slate-200 focus:border-slate-300 resize-none"
          onKeyDown={(e) => {
        ...
        <StyledButton
          ...
          className="absolute bottom-2 right-2 h-8 w-8 p-0 bg-slate-900 hover:bg-slate-800"
        >
      ...
      {generatedBlocks.length > 0 && (
        <div className="space-y-2">
          <p className="text-xs font-medium text-slate-600">Recently Created</p>
              ...
              >
                <div className="aspect-[4/3] rounded-lg overflow-hidden bg-gradient-to-br from-violet-100 to-purple-100 border border-violet-200 group-hover:border-violet-400 group-hover:shadow-lg transition-all relative flex items-center justify-center">
                  <div className="text-center p-2">
                    <LayoutGrid className="h-6 w-6 text-violet-400 mx-auto mb-1" />
    ...
    try {
      ...
      if (data.success && data.image) {
        ...
        toast({
          ...
          description:
            data.image.source === "vertex-ai-imagen-3" ? "Generated image added." : "Image found and added.",
        })
      } else if (data.error) {
