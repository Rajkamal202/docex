...
import { analyzeProposal } from "@/lib/studio-gemini"
...
export async function POST(req: NextRequest) {
  try {
    ...
    const { content, tone, industry, goals } = body
    ...
    const validIndustry = VALIDATION.allowedIndustries.includes(industry) ? industry : "general"

    const analysis = await analyzeProposal(content, validTone, validIndustry, goals)
