...
export async function GET(request: Request) {
  try {
    ...
    console.log("[v0] [Blocks API] LN_SUPABASE_URL exists:", !!process.env.LN_NEXT_PUBLIC_SUPABASE_URL)
    console.log("[v0] [Blocks API] SERVICE_ROLE_KEY exists:", !!process.env.LN_SUPABASE_SERVICE_ROLE_KEY)
